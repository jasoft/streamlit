...
SKILL_NAME = "hithink-zhishu-query"
SKILL_VERSION = "1.0.0"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="问财指数数据 - 指数数据查询工具",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=f"""
使用示例:
  python3 scripts/cli_index.py --query "上证指数涨跌幅"
  python3 scripts/cli_index.py --query "沪深300最新点位"
  python3 scripts/cli_index.py --query "创业板指成交量" --page "2" --limit "20"
  python3 scripts/cli_index.py --query "恒生指数行情" --api-key "your-key"
