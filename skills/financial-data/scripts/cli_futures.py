...
SKILL_NAME = "hithink-futures-query"
SKILL_VERSION = "1.0.0"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="问财期货期权 - 期货期权数据查询工具",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=f"""
使用示例:
  python3 scripts/cli_futures.py --query "沪铜期货最新行情"
  python3 scripts/cli_futures.py --query "50ETF期权隐含波动率"
  python3 scripts/cli_futures.py --query "螺纹钢期货会员持仓排名" --page "2" --limit "20"
  python3 scripts/cli_futures.py --query "原油期货库存数据" --api-key "your-key"
